...
function showMovies(clearMovies = false) {
  ...
  if (moviesArray.length > 0) {
    moviesArray.forEach((movie) => {
      ...
      movieContent.innerHTML =
        movieContent.innerHTML + //Estamos usando template literal, que é o nome quando utilizamos o acento grave(esse pra esquerda).
        // Utilizando ele nós conseguimos utilizar variaveis com mais facilidade.
